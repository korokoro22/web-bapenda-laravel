...
<div class=" mt-6 w-11/12 mx-auto border-b border-black">
    <p class="font-inter font-bold ml-7">PENAMBAHAN SURAT MASUK</p>
</div>
<div class="mt-8 w-9/12 mx-auto">
<form action="{{route('surat-masuk.store')}}" method="post" class="mx-auto" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-5 w-full">
        ...
        <input type="text" id="nomor-surat" class="border-2 border-gray-300 rounded px-3 py-2 w-full" name="pengirim" value="{{old('pengirim')}}" required autofocus>
    </div>
    
    <div class="mb-5 w-full">
        <lable class="text-lg font-semibold font-inter">Tanggal Diterima</lable> <br>
        <input id="datepicker" class="border-2 border-gray-300 rounded px-3 py-2 w-full" type="text" placeholder="Select a date" name="tglterima" value="{{old('tglterima')}}">
    </div>
    
    <div class="mb-5 w-full">
        <lable class="text-lg font-semibold font-inter">Tanggal Diteruskan</lable> <br>
        <input id="datepicker" class="border-2 border-gray-300 rounded px-3 py-2 w-full" type="text" placeholder="Select a date" name="tglteruskan" value="{{old('tglteruskan')}}">
    </div>
