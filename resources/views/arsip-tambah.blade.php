...
<form action="{{route('arsip-pergub.store')}}" method="post" class="mx-auto" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-5 w-full ">
        ...
        <a href="arsip-pergub" class="p-2 rounded-md bg-gray-400 hover:bg-gray-600 text-white font-inter">KEMBALI</a>
    </div>
